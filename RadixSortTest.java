...
public class RadixSortTest {
	...
	int max = 2*n;
        ...
        System.out.println(type+"Sort large random array size " +
                            n + " ...");
        Integer [] a = ArrayBuilder.getRandom(n, 23);
        testWith(type, a, r, max);

        //sort an inorder array of size n
        System.out.println(type+"Sort large in order array size " +
                            n + " ...");
        a = ArrayBuilder.getInorder(n);
	testWith(type, a, r, max);

        //sort a reverse order array of size n
        System.out.println(type+"Sort large reverse order array size " +
                            n + " ...");
