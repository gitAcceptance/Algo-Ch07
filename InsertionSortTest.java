...
public class InsertionSortTest {
	...
	n = Integer.parseInt(args[0]);
        ...
        System.out.println("InsertionSort large random array size " +
                            n + " ...");
	...
	testWith(a, "insertion");
        ...
        System.out.println("InsertionSort large in order array size " +
                            n + " ...");
        a = ArrayBuilder.getInorder(n);
	testWith(a, "insertion");

        // insertion sort a reverse order array of size n
        System.out.println("InsertionSort large reverse order array size " +
                            n + " ...");
	...
	// example    5 3 1 2 4
        System.out.println("InsertionSort smallest in middle array size " +
                            n + " ...");
        a = ArrayBuilder.getSmallestInMiddle(n);
	testWith(a, "insertion");
	
        // double insertion sort a random array of size n
        System.out.println("Double InsertionSort large random array size " +
                            n + " ...");
        a = Arrays.copyOf(copyA, n);
	testWith(a, "double");

        // double insertion sort an inorder array of size n
        System.out.println("Double InsertionSort large in order array size " +
                            n + " ...");
        a = ArrayBuilder.getInorder(n);
	testWith(a, "double");

        // double insertion sort a reverse order array of size n
        System.out.println("Double InsertionSort large reverse order array size " +
                            n + " ...");
        a = ArrayBuilder.getReverseOrder(n);
	testWith(a, "double");
	...
	// example    5 3 1 2 4
        System.out.println("Double InsertionSort smallest in middle array size " +
                            n + " ...");
        a = ArrayBuilder.getSmallestInMiddle(n);
	testWith(a, "double");
